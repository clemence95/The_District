...
class CommandeController extends AbstractController
{
    ...
    public function validerCommande(Request $request, PanierService $panierService, EntityManagerInterface $entityManager): Response
    {
        ...
        // Ajoutez ceci pour déboguer et voir le contenu du panier
        // dd($panier);
        ...
        foreach ($panier as $panierItem) {
            // Assurez-vous que les clés 'prix', 'quantite', et 'plat' existent dans $panierItem
            if (isset($panierItem['prix'], $panierItem['quantite'], $panierItem['plat'])) {
                // Utilisez directement les propriétés du plat pour le calcul
                $prix = $panierItem['plat']->getPrix();
